  ...
  return (
    <div className="relative w-full sm:w-auto" ref={dropdownRef}>
      <motion.button
        ...
        className="w-full sm:w-48 group relative flex items-center gap-2 px-4 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] 
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full sm:min-w-[240px] bg-[#1e1e2e]/95 
